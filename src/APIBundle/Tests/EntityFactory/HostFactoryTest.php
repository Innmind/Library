...
class HostFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->f = new HostFactory(
            $this->d = new EventDispatcher,
            new DomainFactory(new EventDispatcher)
        );
    }
    ...
    public function testBuild()
    {
        ...
        $this->d->addListener(
            ...
            function (RelationshipBuildEvent $event) use (&$fired, $e) {
                ...
                $this->assertInstanceOf(ResourceOfHost::class, $rel);
                $this->assertInstanceOf(Host::class, $rel->getHost());
                $this->assertSame('www.foo.fr', $rel->getHost()->getHost());
